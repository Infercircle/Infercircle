...
const BitcoinDominance: React.FC = () => (
  <div className="flex flex-col items-center justify-center">
    <h3 className="text-sm font-semibold text-gray-200 mb-4">Bitcoin Dominance</h3>
    <div className="flex items-center gap-4 mb-2">
      <div className="flex flex-col items-center">
        ...
        <span className="text-xs text-green-400 font-semibold">+0.03%</span>
    ...
    <div className="w-full mt-2">
      ...
      <div className="relative h-2 bg-[#23272b] rounded-full">
        ...
        >
          <span className="absolute left-1/2 -translate-x-1/2 -top-6 text-xs font-semibold text-gray-200">
