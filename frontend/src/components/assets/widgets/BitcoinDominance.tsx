...
const BitcoinDominance: React.FC = () => (
  <div className="flex flex-col items-center justify-center">
    <h3 className="text-base font-semibold text-gray-200 mb-4">Bitcoin Dominance</h3>
    <div className="flex items-center gap-4 mb-2">
      <div className="flex flex-col items-center">
        <FaBitcoin className="text-yellow-400 w-5 h-5 mb-1" />
        <span className="text-xl font-bold text-gray-100">{btcDominance}%</span>
      ...
      <div className="flex flex-col items-center">
        ...
        <span className="text-xl font-bold text-gray-100">{ethDominance}%</span>
        <span className="text-base text-green-400 font-semibold">+0.03%</span>
    ...
    <div className="w-full mt-2">
      ...
      <div className="relative h-2 bg-[#23272b] rounded-full">
        ...
        >
          <span className="absolute left-1/2 -translate-x-1/2 -top-6 text-base font-semibold text-gray-200">
