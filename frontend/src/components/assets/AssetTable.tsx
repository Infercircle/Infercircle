...
const mapTokenToTable = (token: TokenData, idx: number): TableToken => ({
  ...
  name: token.name,
  symbol: token.symbol,
  price: token.current_price !== undefined ? `$${token.current_price.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : "-",
  ...
  marketCap: token.market_cap !== undefined ? `$${token.market_cap.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : "-",
  volume24h: token.total_volume !== undefined ? `$${token.total_volume.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : "-",
  supply: token.circulating_supply !== undefined ? `${token.circulating_supply.toLocaleString()} ${token.symbol}` : "-",
  icon: token.image,
