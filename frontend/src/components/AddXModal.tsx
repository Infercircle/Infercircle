        ...
        <CardHeader className="text-center pb-4">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 bg-[#A259FF]/10 rounded-full flex items-center justify-center">
              {isGoogle ? <FaGoogle className="text-3xl text-[#A259FF]" /> : <FaXTwitter className="text-3xl text-[#A259FF]" />}
            </div>
          </div>
          <CardTitle className="text-white text-xl font-semibold">Connect Your {isGoogle ? 'Google' : 'X'} Account</CardTitle>
          {!isGoogle ? (
